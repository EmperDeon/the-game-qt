...
#define logE(ms) GV_LOGGER->log(GLogLevel::ERR,    Q_FUNC_INFO /*this->className*/, ms)
#define logW(ms) GV_LOGGER->log(GLogLevel::WARN,   Q_FUNC_INFO /*this->className*/, ms)
#define logI(ms) GV_LOGGER->log(GLogLevel::INFO,   Q_FUNC_INFO /*this->className*/, ms)
